...
<code>/restrict</code> - Полное ограничение пользователя
<code>/unrestrict</code> - Снять ограничения
<code>/ban_links</code> - Запретить ссылки
<code>/allow_links</code> - Разрешить ссылки
...
• Нельзя отправлять ссылки на VK
